CC       = GCC
NAME = cub3D
CFLAGS   = -Wall -Wextra -Werror -g3 -fsanitize=address -Imlx -finline-functions -fvectorize -fslp-vectorize -ffast-math -falign-functions -funroll-loops -fstrict-aliasing -fomit-frame-pointer -flto -Ofast -O1 -O2 -Os -O3
