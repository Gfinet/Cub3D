...
/*   Updated: 2024/07/12 20:18:22 by lvodak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	y0 = c->player->pos.y;
// 	x0 = c->player->pos.x;
// 	if ((keycode == W || keycode == A) && c->maps->c_maps[y0][x] == '1'
// 		&& c->maps->c_maps[y][x0] == '1')
// 		return (1);
// 	y = c->player->pos.y + (-1 * dir.y > 0) * 0.26 - (-1 * dir.y < 0) * 0.26;
// 	x = c->player->pos.x + (-1 * dir.x > 0) * 0.26 - (-1 * dir.x < 0) * 0.26;
// 	if ((keycode == S || keycode == D) && c->maps->c_maps[y0][x] == '1'
// 		&& c->maps->c_maps[y][x0] == '1')
// 		return (1);
// 	return (0);
// }
...
// 	if ((key == W || key == A) && ((c->maps->c_maps[(int)yp][(int)xp] == '1')
// 		|| (c->maps->c_maps[(int)(yp - dir.y / 2)][(int)(xp - dir.x / 2)]
// 		== '1')))
// 		return (1);
// 	else if ((key == S || key == D) && ((c->maps->c_maps[(int)ym][(int)xm]
// 			== '1') || (c->maps->c_maps[(int)(ym + dir.y / 2)][(int)(xm + dir.x
// 		/ 2)] == '1')))
// 		return (1);
// 	return (0);
// }
...
{
	if (c->maps->c_maps[(int)player->pos.y][(int)new_p.x] == '1'
		|| c->maps->c_maps[(int)new_p.y][(int)player->pos.x] == '1')
		return (0);
	return (1);
}